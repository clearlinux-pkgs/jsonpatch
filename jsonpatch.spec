...
Version  : 1.30
Release  : 51
URL      : https://files.pythonhosted.org/packages/bb/cd/dd097ce40a56e9f296e923e6884280b33f69cd54c5ed1937e3ff1717104a/jsonpatch-1.30.tar.gz
Source0  : https://files.pythonhosted.org/packages/bb/cd/dd097ce40a56e9f296e923e6884280b33f69cd54c5ed1937e3ff1717104a/jsonpatch-1.30.tar.gz
...
%prep
%setup -q -n jsonpatch-1.30
cd %{_builddir}/jsonpatch-1.30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614784556
...
cp %{_builddir}/jsonpatch-1.30/COPYING %{buildroot}/usr/share/package-licenses/jsonpatch/0305317c0f694ba11e8f059938fd0c880356e7bc
