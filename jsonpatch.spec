...
%prep
%setup -q -n jsonpatch-1.28
cd %{_builddir}/jsonpatch-1.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606924903
...
cp %{_builddir}/jsonpatch-1.28/COPYING %{buildroot}/usr/share/package-licenses/jsonpatch/0305317c0f694ba11e8f059938fd0c880356e7bc
