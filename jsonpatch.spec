...
%prep
%setup -q -n jsonpatch-1.26
cd %{_builddir}/jsonpatch-1.26
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592836717
...
cp %{_builddir}/jsonpatch-1.26/COPYING %{buildroot}/usr/share/package-licenses/jsonpatch/0305317c0f694ba11e8f059938fd0c880356e7bc
